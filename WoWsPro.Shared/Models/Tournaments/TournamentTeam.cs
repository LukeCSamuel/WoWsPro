...
namespace WoWsPro.Shared.Models.Tournaments
{
	public class TournamentTeam
	{
		...
		public ICollection<TournamentMatch> AlphaMatches { get; set; }
		public ICollection<TournamentMatch> BravoMatches { get; set; }
		public ICollection<TournamentGame> GamesWon { get; set; }
		public ICollection<RegistrationQuestionResponse> QuestionResponses { get; set; }


		public IEnumerable<TournamentMatch> GetTournamentMatches ()
		{
			return AlphaMatches.Union(BravoMatches);
		}
	}
}
